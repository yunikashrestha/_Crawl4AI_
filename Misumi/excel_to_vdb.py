...
file_name = "Bearing_lock_nuts_washer_for_rolling_bearings_retaining_and_tightening_washer_series_awl.xlsx"
...
category_name= " ".join(file_parts[0:3])
...
def to_vectordb():
    ...
    file_parts=name.split('_')
    category_name= " ".join(file_parts[0:3])
    subcategory_name=" ".join(file_parts[3:])
            ...
            points = [
                models.PointStruct(
                    ...
                    payload = {
                            ...
                            "website" :"NSK",
                            "chunk" : row["combined_text"] +" | "+"Url: "+ url +" | "+"Website: NSK",
                            "URL":url
                        },
                    vector = {
    ...
    f"Total time required:{elapsed_time:.4f} seconds \n"
